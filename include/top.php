    ...
    <nav class="container d-flex flex-column flex-md-row justify-content-between">
      ...
      ?>
          ...
          <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
            <li>
              <h6 style="margin-left: 15px;">Hey,<b style="font-size:20px;  "><?php echo "Admin"; ?></b></h6>
            </li>
        ...
        ?>
          ...
          <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
            <li>
              <h6 style="margin-left: 15px;">Hey,<b style="font-size:20px;  "><?php echo $_SESSION['first_name']; ?></b></h6>
            </li>
      ...
      <a class="m-2" href="cart.php"><i class="fa fa-shopping-cart"></i> Cart(<?= cartCounter(); ?>)</a>
    </nav>
  </header>
  <main>